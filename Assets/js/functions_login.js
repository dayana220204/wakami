...
// funciones para el modal de recuperar contraseña

document.addEventListener('DOMContentLoaded', () =>  {
	document.getElementById("OpenModalResetPass").addEventListener("click", () => {
		document.getElementById("modal_reset_password").style.display = "block";
	})
